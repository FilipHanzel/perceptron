...
from perceptron.data_utils import transpose, normalize, to_categorical
...
if __name__ == "__main__":
    ...
    *features, targets = transpose(data)
    ...
    print("Cross validating with builtin zscore normalization and adam...")
    random.seed(0)
    ...
    print("Cross validating with builtin zscore normalization and nesterov momentum...")
    random.seed(0)
